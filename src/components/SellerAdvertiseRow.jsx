...
const SellerAdvertiseRow = ({ advertise, handleDeleteAdvertise }) => {
    return (
                ...
                <div className=" w-full pb-4">
                    <div className="flex justify-between h-full items-center w-full pb-2 space-x-2 space-y-2">
                        <div className="space-y-4">
                            ...
                            <div onClick={() => handleDeleteAdvertise(advertise._id)} className="flex text-sm divide-x hover:text-red-500">
